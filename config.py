...
TUT_VID = os.environ.get("TUT_VID","https://t.me/neelakurinji_vip/6")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "1543571636 1480923991 6891576089 1959900975 6891576089").split()):
        ADMINS.append(int(x))
except ValueError:
...
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>» ʙʏ @neelakurinji_vip</b>")
